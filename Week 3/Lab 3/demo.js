...
function Fibulator(){
/*The indexOf(f) function at the end to display the 'position' of the Fib number in the sequence
returns 1,1,3,4... instead of 1,2,3,4 - I think it's storing references to fib[0] and fib[1] as the
same because they have the same value - I didn't dig into it to fix it, and I don't know if I could 
even if I tried... */
